...
label2.config(
    text="""Simple Label [Sunken, borderwidth=30,
fixed size 200,100]
fixed location""",
)
...
FULL = False
title = tk.Label(
    sc, text="Responsive GUI", fg="cyan", bg="#111", font=("broadway", 22, "italic")
)
title.place(relx=0.5, rely=0, anchor="n", relwidth=1)

footer = tk.Label(
    sc,
    text="COPYRIGHTS @ hmae.py",
    fg="cyan",
    bg="#111",
    font=("broadway", 22, "italic"),
)
...
textwidget.tag_config(
    "center", justify="center", foreground="orange", font=("courier", 12, "bold")
)
textwidget.tag_config(
    "red", justify="center", foreground="#f44", font=("courier", 12, "bold")
)
